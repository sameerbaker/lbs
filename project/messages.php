...
<section class="section">
  <div class="row">
    <div class="col-lg-12">
      ...
      <div class="card">
        <div class="card-body">
          <h5 class="card-title">  Your  Encrypted Inbox Messages :  </h5>
             ...
             <div class="card-content">
                                    <div class="card-body card-dashboard">
                                        ...
                                        <div class="table-responsive">
                                         ...
                                         <?php 
                                         $counter =1;
                                         $sql = "SELECT * FROM history where to_uid = ".$_SESSION['user']['id']." order by id desc";
                                          ...
                                          if ($result->num_rows > 0) {
                                            ...
                                            while($row = $result->fetch_assoc()) {
                                               ...
                                               echo '  <tr role="row" class="even">
                                                       ...
                                                       <td>'. $row['id'].'</td>
                                                       <td> 
                                                           <a href="'. $row['result_path'].'" data-lightbox="example-1">
                                                            <img src="'. $row['result_path'].'" alt="Lights" width="200" height="200" >
                                                          </a>
                                                       </td>
                                                       <td>'. $row['note'].'</td>
                                                       <td>'. $row['date'].'</td>
